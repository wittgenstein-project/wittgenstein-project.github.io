...
![{\displaystyle K_{n}=\sum _{v=0}^{n}{\binom {n}{v}}}](images/fe8e3530ddfe568a9d945e402d5a6a0a9540bc43.svg)
...
![{\displaystyle \sum _{k=0}^{K_{n}}{\binom {K_{n}}{k}}=L_{n}}](images/3bbf7a05fae70d7221d6ecba5775f538fa7fd7ad.svg)
...
![{\displaystyle \vdash }](images/a0c0d30cf8cb7dba179e317fcde9583d842e80f6.svg)
...
**5.15** If *Tr* is the number of the truth-grounds of the proposition "*r*", *Tr* the number of those truth-grounds of the proposition "*s*" which are at the same time truth-grounds of "*r*", then we call the ratio *T*~rs~ : *T*~r~ the measure of the *probability* which the proposition "*r*" gives to the proposition "*s*".

**5.151** Suppose in a schema like that above in No. [5.101](#5.101) *Tr* is the number of the "T"'s in the proposition *r*, *Trs* the number of those "T"'s in the proposition *s*, which stand in the same columns as "T"'s of the proposition *r*; then the proposition *r* gives to the proposition *s* the probability *T*~rs~ : *T*~r~.
...
**5.441** This disappearance of the apparent logical constants also occurs if "~(∃ *x*) . ~*f x*" says the same as "(*x*) . *f x*", or "(∃ *x*) . *fx* . *x* = *a*" the same as "*f a*".
...
![{\displaystyle ({\bar {\xi }})}](images/42b19dfaf444189c43300c710b904dcefda799cf.svg)
...
(Thus if *ξ* has the 3 values P, Q, R, then 
![{\displaystyle ({\bar {\xi }})}](images/42b19dfaf444189c43300c710b904dcefda799cf.svg)
...
![{\displaystyle N({\bar {\xi }})}](images/688f31c8b53de2e85798d6e29f50789fa64eb1e7.svg)
".
...
**5.52** If the values of *ξ* are the total values of a function *f x* for all values of *x*, then 
![{\displaystyle N({\bar {\xi }})=\sim (\exists x).fx}](images/0b05e9921dcb9c630e657139fcd3b968725a94c2.svg)
.
...
**5.525** It is not correct to render the proposition "(∃ *x*) . *f x*"—as Russell does—in words "*f x* is *possible*".
...
**5.5261** A completely generalized proposition is like every other proposition composite. (This is shown by the fact that in "(∃ *x*, *φ*) . *φ x*" we must mention "*φ*" and "*x*" separately. Both stand independently in signifying relations to the world as in the ungeneralized proposition.)
...
**5.5321** Instead of "(*x*) : *f* *x* ⊃ *x* = *a*" we therefore write *e.g.* "(∃*x*) . *f* *x* . ⊃ . *f* *a* : ~(∃ *x*, *y*) . *f* *x* . *f* *y*".
...
![{\displaystyle [{\bar {p}},{\bar {\xi }},N({\bar {\xi }})]}](images/2280fc5b18f2a18924aeac15d592429f9a30389c.svg)
.
...
![{\displaystyle \Omega '({\bar {\eta }})}](images/669318bd2a57168707932f4274df0f1802173d37.svg)
...
![{\displaystyle x=\Omega ^{0\prime }x{\text{ Def.}}}](images/f1e7816f45d64cbe3aad02f6f0925ae55ade7666.svg)
...
as: 
![{\displaystyle \Omega ^{0\prime }x,\Omega ^{0+1\prime }x,\Omega ^{0+1+1\prime }x,\Omega ^{0+1+1+1\prime }x,.....}](images/6c8f120df1bc77d49c884554cdfc6fd58baa1204.svg)

Therefore I write in place of "
![{\displaystyle [x,\xi ,\Omega '\xi ]}](images/647cd7f45d7d8e877cdb29758e7c4dd75f1d5dd5.svg)
",
