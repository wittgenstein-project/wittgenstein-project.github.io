...
„(∃*x*) : *aRx . xRb*“, „(∃*x, y*) : *aRx . xRy . yRb*“, u. s. f.
...
(Hat also 
![{\displaystyle \xi }](images/e0b461aaf61091abd5d2c808931c48b8ff9647db.svg)

etwa die 3 Werte P, Q, R, so ist (
![{\displaystyle {\bar {\xi }}}](images/bcc3567c88be2979b903c85f35c19be4dd92aef7.svg)
) = (P, Q, R).)
...
**5.502** Ich schreibe also statt „(– – – – –W)(*ξ, . . . .*)“ „*N* (
![{\displaystyle {\bar {\xi }}}](images/bcc3567c88be2979b903c85f35c19be4dd92aef7.svg)
)“.

„*N* (
![{\displaystyle {\bar {\xi }}}](images/bcc3567c88be2979b903c85f35c19be4dd92aef7.svg)
)“ ist die Negation sämtlicher Werte der Satzvariablen 
![{\displaystyle \xi }](images/e0b461aaf61091abd5d2c808931c48b8ff9647db.svg)
.
...
**5.52** Sind die Werte von *ξ* sämtliche Werte einer Funktion *fx* für alle Werte von *x*, so wird *N* (
![{\displaystyle {\bar {\xi }}}](images/bcc3567c88be2979b903c85f35c19be4dd92aef7.svg)
) = ∼(∃*x*) *. fx*.
...
![{\displaystyle N'({\bar {\xi }})}](images/2ab10eb80d5db3ae7e57da86a496c009f040deca.svg)
...
![{\displaystyle {\text{(u. s. f.)}}}](images/fddbdcb548b5d15ae60c55b48aa2082aeb11f67b.svg)
...
![{\displaystyle [0,\xi ,\xi +1]}](images/4dec130b82634fa09cc82069b96774e9c1d9b93c.svg)
.
