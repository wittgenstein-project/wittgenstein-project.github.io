...
**5.52** Sind die Werte von *ξ* sämtliche Werte einer Funktion *fx* für alle Werte von *x*, so wird ![{ N ( \bar{\xi} ) }](images/b3394a04eba3cf3b36ede15e974e646aa098169220c2c60478507502e024c872.svg)\  = ∼(∃*x*) *. fx*.
...
**6** Die allgemeine Form der Wahrheitsfunktion ist: ![{ [ \bar{p}, \bar{\xi}, N (\bar{\xi}) ] }](images/336cae8a41089348ef601ba5dbe893d3758f7baa1841701bd587566e0f16d282.svg)\ .

Dies ist die allgemeine Form des Satzes.

**6.001** Dies sagt nichts anderes, als dass jeder Satz ein Resultat der successiven Anwendung der Operation ![{ N' (\bar{\xi}) }](images/6f5736dff9d73c6c95c36f30466ceb36b6191d4b51adec9af05bd29016ef01ea.svg)\  auf die Elementarsätze ist.
...
**6.01** Die allgemeine Form der Operation ![{ \Omega ' (\bar{\eta}) }](images/ea9e48f6e881e8a034e4cbc779a077ac01d2da54238fa332cfbe2255015dca69.svg)\  ist also: ![{ [\bar{\xi}, N(\bar{\xi})]' (\bar{\eta}) (= [ \bar{\eta}, \bar{\xi}, N (\bar{\xi}) ]) }](images/d1cf195aa1fb631bffe7b018f1114530b8c1bcc712299ba306fdef8ed6c55335.svg)\ .
...
![{ x = \Omega^{0 \prime} x \text{ Def.} }](images/2c3e0efa8931e01e650511958fc1f6d5b5cba8c4120db825866394563d645203.svg)\  und
![{ \Omega^{\prime} \Omega^{\nu \prime} x = \Omega^{\nu + 1 \prime} x \text{ Def.} }](images/1bd88ac2bf5db57ea9040cc5e72c42410c17abe58b77c117e3bfb0772eaf1d77.svg)\

Nach diesen Zeichenregeln schreiben wir also die Reihe ![{ x, \Omega ' x, \Omega ' \Omega ' x, \Omega ' \Omega ' \Omega ' x, ..... }](images/2bdad2e773a893d516dedb66aae27db7901736d7838298078d42775abc368450.svg)\

so: ![{ \Omega^{0 \prime} x, \Omega^{0+1 \prime} x, \Omega^{0 + 1 + 1 \prime} x, \Omega^{0 + 1 + 1 + 1 \prime} x, ..... }](images/2363c84eb861521de9141a1ef7e7f9b8e30ee559dbe0fdd98ebe96665b1cacc5.svg)\

Also schreibe ich statt „![{ [ x, \xi, \Omega ' \xi ] }](images/356a71ba81334c39be3a91a1d42c9d51eb9ad1ea7b726f750fd3a307d7947385.svg)\ “:

„![{ [ \Omega^{0 \prime} x, \Omega^{\nu \prime} x, \Omega^{\nu + 1 \prime} x ] }](images/6dfd74305dc6480d900085f169502024845a873e4e905856bf37dbc80f3bb653.svg)\ “.
...
**6.03** Die allgemeine Form der ganzen Zahl ist: ![{ [ 0, \xi, \xi + 1] }](images/b62025c4a407e7eb826ef60301c7aba855768d91af1e7b6d3248a9d8c43658f1.svg)\ .
...
![{ ( \Omega^{\nu} )^{\mu \prime} x = \Omega^{\nu \times \mu \prime} x \text{ Def.} }](images/3b27b08186c4d2531ace97a6a386ca76d9996f0b7f4701697fb39daebd242145.svg)\
